          ...
          <h2 class="line_type">
            ...
            <div class="box_contents">
              ...
              <ul class="list_type1 configure">
                ...
                <li class="error">현재가의 +-5% 범위로 재설정해주세요.</li>
                <li>
                ...
                <li class="error">매수고가의 -0.5% ~ -10% 범위로 재설정해주세요.</li>
                <li class="error">현재가보다 낮거나 같은 범위로 재설정해주세요.</li>
                <li>
                  <span class="txt01">목표가</span>
                  <span class="txt02">
                    <span class="tag_blue small">+1.24%</span>
                    <span class="txt_blue1">$ 0.1234567890</span>
                    <button class="ico_configure"/>
                  </span>
                </li>
                <li class="error">매수고가의 10~1000% 범위로 재설정해주세요.</li>
                <li>
                  <span class="txt01">손절가</span>
                  <span class="txt02">
                    <span class="tag_red small">-0.81%</span>
                    <span class="txt_red1">$ 0.1234567890</span>
                    <button class="ico_configure"/>
                  </span>
                </li>
                <li class="error">매수고가보다 10%이상 낮아야 합니다.</li>

        ...
        <div class="con_box">
          ...
          <div class="box_contents pdt16"> 
            ...
            <div class="tab_contents" v-if="tab1 == 'A'">
              ...
              <div class="mga32">
                이 종목은 상승이후 지지라인을 이탈하는 모습을 보였으나 저항구간을 재차 돌파하며 상승의 의지를 보여주고 있는 종목으로 현재 돌파 이후 눌림목 구간으로 공략이 가능해보인다.
              </div>
              <div class="divider" />
              <h3 class="between">
...
export default {
  components: { MDialogBlank,GaugeChart, Swiper, SwiperSlide, VClamp, MChipList, MChip, DefaultTable },
    name: 'H_33200_T',

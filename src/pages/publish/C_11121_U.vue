    ...
    <q-form>
      <div class="con_box">
        <div style="padding:32px">
          <m-button-3 @click="dailog2 = true" lined color="primary">매수고가 설정</m-button-3>
        </div>
        <!-- S 매수고가 설정 -->
        <m-dialog v-model="dailog2">
          <div class="dailog_wrap">
            ...
            <q-card-section class="dailog_contents">
              <p class="dialog_tit l_row_l">매수고가 설정</p>
              <p class="txt_dk">설정 가능 범위 : <span class="primary">현재가의 -5.0 ~ +5.0%</span></p>
              ...
              <div class="btn_wrap l_row"><m-button-3 color="primary" class="full" size="large">저장하기</m-button-3></div>
            </q-card-section>
          </div>
        </m-dialog>
        <!-- E 매수고가 설정 -->
...
export default {
  ...
  data() {
    return {
      ...
      tab1: ref('G'),
      tabs: [
        { label: '은행', value: 'G', icon: '' },
        { label: '증권사', value: 'F', icon: '' }
      ],
    }
  },
  methods: {

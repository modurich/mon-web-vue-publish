    ...
    <div class="centerarea_box1">
        <div class="con_box">
          ...
          <div class="box_contents">  
            <div class="search_input l_row_sl">
            ...
            <div class="best_wrap">
              ...
              <ul class="best_list">
                <li>
                  <span class="num_txt">6</span>
                  북한미사일
                </li>
                <li>
                  <span class="num_txt">7</span>
                  북한미사일
                </li>
                <li>
                  <span class="num_txt">8</span>
                  북한미사일
                </li>
                <li>
                  <span class="num_txt">9</span>
                  북한미사일
                </li>
                <li>

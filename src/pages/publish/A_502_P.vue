    ...
    <q-form>
      <div class="con_box">
        <div style="padding:32px">
          <m-button-3 @click="dailog2 = true" lined color="primary">팔로우 추가</m-button-3>
        </div>
        <!-- S 종목 공개하기 -->
        <m-dialog v-model="dailog2">
          <div class="dailog_wrap">
            ...
            <q-card-section class="dailog_contents">
              <p class="dialog_tit l_row_l">팔로우 추가</p>
              <div class="ico_top center mgb16">
                <i class="ico_follow"></i>
              </div>
              <div class="l_row">
               <p class="font12">해당 플레이어를 팔로우하시겠습니까?  <br/>
                팔로워는 새 콘텐츠 알림을 받을 수 있습니다.</p>
              </div>

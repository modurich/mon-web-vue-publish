<template>
  <div class="centerarea_box1">
      <div class="con_box">
        <h2 class="line_type">인사이트 인기 종목</h2>
        <m-tabs class="line_type large sticky_tab1" v-model="tab1" :items="tabs" />
          <div class="tab_contents" v-if="tab1 == 'A'">
            ...
            <ul class="product_list mgt16">
              ...
              <li>
                <div class="prd_img">
                  <span class="txt_number">100</span>
                  <div class="img_area small">
                    <img src="~assets/prd_logo.png" alt="profile" />
                  </div>
                  <div class="tit_area">
...
data() {
      return {
        ...
        tab2: ref('A'),
        tabs1: [
          { label: '급상승', value: 'A', icon: '' },
          { label: '급하락', value: 'B', icon: '' },
          { label: '거래량', value: 'C', icon: '' },
          { label: '인기', value: 'D', icon: '' },
          { label: '관심', value: 'E', icon: '' },
        ],
      }
  },
  methods: {
